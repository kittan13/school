...
optitle={'xycoords':'data','textcoords':'offset points','fontproperties':goth,'size':12}
...
fpmi = {
    ...
    '滋賀県':[1.82, 2.07, 1.77, 2.47,3.12, 3.78, 4.30]}
    #'鳥取県':[2.69, 3.24, 2.86, 4.24,3.56 ,3.44, 2.87,5.66], 
        #'全国': [2.63, 3.55, 3.63, 4.557,3.56 ,3.44, 2.87,1.26]
def ex05 (pref, epochO, ndays, xlim, xticks, ylim, yticks, pngfile, log=False, rotation=28, pad=-2):
    ...
    covid.drawFrame (pref + '　　定点医療機関 定点あたり報告数　　Y210251 大保心',
                     optitle, ax, xlim, xticks, ylim, yticks, rotation=rotation, pad=pad) 
    ax.bar ([d[0] for d in weekly2['Week']], weekly2[pref],
            label=f'定点あたり報告数',**{**opbar,'width':7.0}) 
    ax.bar (fpmi ['Week'], np.array (fpmi[pref]),
...
if __name__== '__main__':
    ...
    ex05 (pref, epochO, ndays, xlim, xticks, ylim, yticks, 
          'ex05.png', log=True)