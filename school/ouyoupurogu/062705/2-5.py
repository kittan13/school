...
def ex05(pref, epoch0, ndays, xlim, xticks, ylim, yticks, pngfile, fac=1, log=False, rotation=28, pad=-2):
    ...
    ax.text(0, -0.2, pref + "定点医療機関 定点あたりの報告数", transform=ax.transAxes, fontproperties=goth, size=12, ha="left", va="top")  # タイトルを下側に配置する
    ax.set_title("Y210231 北村拓也", fontproperties=goth, size=12, ha="center")  # "Y210231 北村拓也"の文字列を中央ぞろえにする
