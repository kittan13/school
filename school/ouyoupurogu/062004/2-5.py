...
def ex04(pref, epoch0, ndays, xlim, xticks, ylim, yticks, 
    ...
    #daily_per_100k_7days = daily[p + ' 7days'] * (100000 / population)
    ...
    #ax.plot(daily['Date'], daily_per_100k_7days, label = '10万人あたりの7日間移動平均', **opplot)
...
if __name__ == "__main__":
    ...
    pref, log, ylim, yticks = '京都府', True, [1,1000], [10,100,1000]
